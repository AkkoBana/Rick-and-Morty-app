...
@AndroidEntryPoint
class LikedCharactersFragment : Fragment() {

    private val vm: LikedCharactersViewModel by viewModels()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        initAdapter()
        vm.fetchLikedCharactersFromTable()
    }
    ...
    private fun observeValues() {
        vm.likedCharactersListLive.observe(viewLifecycleOwner) {
            submitAdapter(it)
        }
    }
